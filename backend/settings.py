"""
Django settings for pawze_backend project.
"""
...
# ---------------------------------------------------------------------------
# Password hashers — Argon2 preferred, BCrypt as fallback
# ---------------------------------------------------------------------------
PASSWORD_HASHERS = [
...
# ---------------------------------------------------------------------------
# Django REST Framework + JWT + Throttling
# ---------------------------------------------------------------------------
REST_FRAMEWORK = {
    ...
    'DEFAULT_THROTTLE_RATES': {
        'anon': '100/day',
        'user': '1000/hour',
        'auth': '5/minute',     # applied explicitly on login/register
    },
}
